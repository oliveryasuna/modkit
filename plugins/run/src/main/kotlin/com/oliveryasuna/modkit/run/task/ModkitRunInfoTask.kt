package com.oliveryasuna.modkit.run.task

import com.oliveryasuna.modkit.run.mapping.hotswapReport
...
/**
 * Prints the resolved run configurations and probes the running JVM to report
 * whether an enhanced hot-swap runtime (JetBrains Runtime / DCEVM) is in use.
 *
 * Purely diagnostic: it never injects a JVM argument. Inputs are snapshotted at
 * configuration time so the task is cache safe; the JVM probe happens in the
 * action.
 */
